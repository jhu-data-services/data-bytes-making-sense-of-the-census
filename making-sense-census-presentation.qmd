...
## {background-image=/images/db-fall.png}
...
![](https://www.usda.gov/sites/default/files/nass-census-survey-difference-blog-110122.png)
...
::: {.incremental}
- The ACS is the nation's most current reliable and accessible data source for local statistics on critical planning topics such as age, children, commuting, education, and employment. It's a household survey conducted by the Census Bureau that samples about 3 1/2 million addresses each year.
...
::: {.column width="50%"}
![](https://www.arcgis.com/sharing/rest/content/items/401cf2f8549f442ba171fc9df6316b1b/resources/images/widget_103/1642698051100.png)
:::
...
::: {.column width="50%"}
![](https://files.wmich.edu/s3fs-public/images/u3272/2019/USCB%20QF%201.jpg)
:::
...
::: {.column width="50%"}
![](https://www.census.gov/content/dam/Census/gs-imports/social-media-sharing-images/social-image-CEDSCI.png)^[https://www.census.gov/content/dam/Census/gs-imports/social-media-sharing-images/social-image-CEDSCI.png]
:::
